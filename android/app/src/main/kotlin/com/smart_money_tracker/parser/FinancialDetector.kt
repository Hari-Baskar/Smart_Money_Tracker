...
object FinancialDetector {
    private val negativeKeywords = listOf(
        ...
        "will be credited", "under process", "is pending", 
        "awaiting confirmation", "awaiting payment", "is awaiting",
        "pending confirmation", "payment is pending", "payment pending",
        "takes 5-10 minutes", "takes 5 to 10 minutes", "off on your",
